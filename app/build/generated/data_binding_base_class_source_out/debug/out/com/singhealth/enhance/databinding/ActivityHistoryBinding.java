...
public final class ActivityHistoryBinding implements ViewBinding {
  ...
  private ActivityHistoryBinding(@NonNull DrawerLayout rootView,
      @NonNull BottomNavigationView bottomNavigationView, @NonNull DrawerLayout drawerLayout,
      @NonNull NavigationView navigationView, @NonNull TextView noRecordsTV,
      @NonNull RecyclerView recyclerView) {
    this.rootView = rootView;
    this.bottomNavigationView = bottomNavigationView;
    this.drawerLayout = drawerLayout;
    this.navigationView = navigationView;
    this.noRecordsTV = noRecordsTV;
  ...
  public static ActivityHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.noRecordsTV;
      TextView noRecordsTV = ViewBindings.findChildViewById(rootView, id);
      if (noRecordsTV == null) {
        break missingId;
      }
      ...
      return new ActivityHistoryBinding((DrawerLayout) rootView, bottomNavigationView, drawerLayout,
          navigationView, noRecordsTV, recyclerView);
    }
