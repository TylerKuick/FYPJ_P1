...
public final class ActivityAboutBinding implements ViewBinding {
  ...
  private ActivityAboutBinding(@NonNull LinearLayout rootView, @NonNull TextView appVersionTV) {
  ...
  public static ActivityAboutBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.appVersionTV;
      TextView appVersionTV = ViewBindings.findChildViewById(rootView, id);
      if (appVersionTV == null) {
        break missingId;
      }

      return new ActivityAboutBinding((LinearLayout) rootView, appVersionTV);
    }
