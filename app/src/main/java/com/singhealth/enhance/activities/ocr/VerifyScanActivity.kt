...
//    private val dateList = intent.getStringArrayListExtra("dateList")
    ...
    private fun postScanValidation() {
        println("FIELDS: " + sysBPFields)
        println("ListHistory: " + sysBPList)
        println("List: " + sysBPListHistory)
        var errorCount = 0
